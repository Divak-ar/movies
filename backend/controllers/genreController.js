...
const updateGenre = asyncHandler(async (req, res) => {
  try {
    // name of new genre
    const { name } = req.body;
    // id of the old genre that is to be changed (get it from id in user's update request)
    const { id } = req.params;

    // finding that genre on the basis of id
    ...
    // changing the genre in schema and then saving it
    genre.name = name;
